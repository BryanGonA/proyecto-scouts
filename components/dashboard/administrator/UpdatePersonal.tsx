...
export default function ActualizarPersonal({ idPersonal, edit }) {
  ...
  return (
    <>
      <div className={`${styles.titulo} p-5`}>
        <strong>
          <h1>Agregar personal administrativo Grupo Scout Centinelas 113</h1>
        </strong>
      </div>
            ...
            <div className={`container-fluid ${styles.desc}`}>
              ...
              <div className="text-center">
                <div className={styles.photo}>
                  ...
                  />
                  <p style={helloStyles}>
                    *Formato de imagen: JPG, JPEG, PNG. No mayor a 10 MB.
                  </p>
                </div>
                <div className="row">
              ...
              <div className={styles.boton}>
                ...
                <button type="button" className="btn btn-danger" ref={cancelar}>
                  <a
                    className={`${styles.letra}`}
                    href={`/dashboard/jefe-grupo/personal/`}
                  >
